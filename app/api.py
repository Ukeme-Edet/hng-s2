...
def get_user(id):
    try:
        ...
        if current_user.userId == id or any(
            [org in user.organisations for org in current_user.organisations]
        ):
            return jsonify(
                {
                    "status": "success",
            ...
            jsonify(
                {
                    ...
                    "statusCode": 401,
                    "cuo": [org.org_id for org in current_user.organisations],
                    "uo": [org.org_id for org in user.organisations],
                }
            ),
            401,
        )
